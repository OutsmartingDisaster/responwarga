    ...
    const fetchStats = async () => {
      try {
        const [orgsRes, reportsRes, opsRes, respondersRes] = await Promise.all([
          fetch('/api/super-admin/stats/organizations'),
          fetch('/api/super-admin/stats/reports'),
          fetch('/api/super-admin/stats/operations'),
          fetch('/api/super-admin/stats/responders')
        ]);
